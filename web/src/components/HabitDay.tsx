...
export function HabitDay({completed = 0, amount = 0, date}: HabitDayProps){
  ...
  return(
  <Popover.Root>
      <Popover.Trigger className={clsx("w-10 h-10  border-2 border-zinc-800 rounded-lg",{
  ...
  />
      ...
      <Popover.Portal>
        <Popover.Content className='min-w-[320px] p-6 rounded-t-2xl bg-zinc-900 flex flex-col'>
